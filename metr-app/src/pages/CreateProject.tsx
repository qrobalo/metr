        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full max-w-sm px-4 py-3 border rounded-lg 
          ...
          <div>
            ...
            <input
              ...
              className={`w-full max-w-sm px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${
                errors.client 
                  ? 'border-red-300 focus:ring-red-500' 
                  : 'border-gray-300 focus:ring-[#1e3a8a]'
              }`}
          ...
          <div>
            ...
            <input
              ...
              className="w-full max-w-sm px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full max-w-sm px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] transition-all bg-white"
            >
